      ...
      <div className="popup-container">
        <div className="popup">
          <div className="popup-inner">
            <h2 style={{ marginBottom: '20px' }}>Tambah Ruang</h2> {/* Tambahkan margin-bottom di sini */}
            {/* Form tambah barang di sini */}
            <form>
              <label style={{ marginBottom: '10px' }}>Nama Ruang</label> {/* Tambahkan margin-bottom di sini */}
              <input type="text" name="nama_barang" placeholder='silahkan isi nama ruang' />
